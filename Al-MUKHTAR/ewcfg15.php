...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "15.0.3");
...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'Dbpi3VjW2uFhEegO'); // Random key for encryption
...
$PROJECT_ID = "{0EA10286-4F61-46C1-99C7-B5845D78C542}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$NAVBAR_CLASS = "main-header navbar navbar-expand navbar-light bg-warning border-bottom";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "127.0.0.1", "port" => 3306, "user" => "root", "pass" => "", "db" => "al-mukhtar", "qs" => "`", "qe" => "`");
