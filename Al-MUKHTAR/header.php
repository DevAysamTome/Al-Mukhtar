...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>Logo_d1450.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>Logo_d1450.ico">
<meta name="generator" content="PHPMaker v2019.0.3">
</head>
	...
	<nav class="<?php echo $NAVBAR_CLASS ?>">
		...
		<ul id="ew-navbar" class="navbar-nav">
			<a class="navbar-brand d-none d-md-block" href="/">
				<span class="brand-text">AL-MUKHTAR</span>
			</a>
